...
// TestIsSpecFile_AcceptsYAMLAndJSON guards the file-extension filter
// the walker uses.
...
// TestCollectSpecFiles_SkipsActionsAndDrafts confirms the walker
// mirrors `glyph run`'s directory-discovery rules (actions/, _*.yml,
// *.draft.yml).
